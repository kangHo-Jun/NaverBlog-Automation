...
const CONFIG = {
  ...
  JSON_OUTPUT_FOLDER_ID: '15AXwc1WiLraCJYlt4pXIjkb097By3z9k',  // JSON 파일 다운로드 폴더
  DOCS_OUTPUT_FOLDER_ID: '182B3-CSkXS5DYRhX9SyH_3SDax3pzhuD'   // 구글독스 파일 다운로드 폴더
};
...
function createV7HTMLPrompt(preprocessData, seoKeywords, highlightKeywords, templateData, styleData, geminiContext) {
  ...
  var system = '[역할]\n' +
    ...
    '- 근거 없는 수치 임의 생성 절대 금지 (예: "94% 재주문율", "9년 경력", "400곳 거래처" 등)\n' +
    '- 데이터 없으면 수치 생략하고 정성적 표현으로 대체\n' +
    '- 회사 실적/연혁/거래처 수 등 기업 정보는 절대 임의 생성 금지\n' +
    '- 제공된 원본 글에 있는 수치만 인용 가능\n\n' +
    '[브랜드 노출 원칙]\n' +
